...
<p><i class="fa fa-info-circle"></i> This will backup your '.$settings['site_name'].' Database to '.$_SERVER['DOCUMENT_ROOT'].'/backups/database/</p></div>';  
...
$backup_file_name =  ''.$SERVER['DOCUMENT_ROOT'].'dbbackup-'.$date.'.sql';
...
<?php
$postData = $statusMsg = '<div class="info-msg">
<p><i class="fa fa-info-circle"></i> This will backup your '.$settings['site_name'].' Website to '.$_SERVER['DOCUMENT_ROOT'].'/backups/website/</p></div>';  
